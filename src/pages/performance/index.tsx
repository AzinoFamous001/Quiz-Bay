...
export default function QuizPerformanceDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[url('/Backdrop.jpg')] bg-center bg-cover bg-no-repeat pt-24 pb-12 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        {/* Header - only added safe top padding + responsive text */}
        <div className="text-center mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-2">Quiz Performance</h1>
          <p className="text-lg text-gray-300">Track your progress and improve over time</p>
        </div>

        {/* Back Button - moved to center on mobile */}
        ...
        {/* Summary Cards - only changed grid to 2 cols on mobile */}
        ...
        {/* Charts - only wrapped in ResponsiveContainer + safe padding */}
        ...
        {/* Table - only added horizontal scroll wrapper */}
